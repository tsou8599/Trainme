...
<div id="insert"><a href="<c:url value='/_20_productMaintain/BookPreInsert.do?pageNo=${pageNo}' />" >新增紀錄</a></div>
		...
		<tr height='18' bgColor="${rowColor}">
			...
			<td rowspan='3' width='80'><!-- 
              ...
              --> <img height='100' width='80'
				src='${pageContext.servletContext.contextPath}/_00_init/getBookImage?id=${entry.value.bookId}'></td>
		</tr>
		...
		<TR height='18' bgColor="${rowColor}">
			...
			<TABLE border='1' width='600'>
				<TR>
					...
					出版社：${fn:substring(entry.value.companyName,0,2)}</TD>
				</TR>
			</TABLE>
			</TD>
		</TR>
