    ...
    <section class="forms-section">
      ...
      <div class="forms">
        <div class="form-wrapper is-active">
          ...
          <form action="<c:url value='tr-login.do' />" method="POST" name="loginForm" class="form form-login">
            <fieldset>
              ...
              <div class="input-block">
                ...
                <input id="login-password" type="password" name="pswd" required />
                <div>
        ...
        <div class="form-wrapper">
          ...
          <form class="form form-signup" method="post" action="<c:url value='/_01_tr_register/Tr_RegisterServletMP_new.do'  />"  enctype="multipart/form-data" >
            <fieldset>
              <legend>
              ...
              <div class="input-block">
                <label for="signup-password-confirm">密碼確認 :</label>
                <input id="signup-password-confirm" type="password" name='passwordcheck' required  />
                <div>
              ...
              <div class="input-block">
                ...
                <input id="signup-name" type="text" name='name' value="${param.name}"  required  />
                <div>
              ...
              <div class="input-block">
                <label for="signup-phone">電話 : </label>
                <input id="signup-phone" type="text" name='phone' value="${param.phone}"  required  />
                <div>
              ...
              <div class="input-block">
                <label for="signup-birthday">生日 : </label>
                <input id="signup-birthday" type="date" name='birthday'   required  />
              </div>

              <div class="input-block">
                <label for="signup-id">身分證字號 : </label>
                <input id="signup-id" type="text" name='id' required  />
                <div>
