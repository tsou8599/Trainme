...
//						gymId =  value;
			...
			try {
				...
				if(service.checkverification(gymId) != verification) {
					...
					TrainerBean trainer = new TrainerBean(null, null, name, phone, email, birthday, password, id, sex, year, gymId, null, null);
