...
@WebServlet("/_01_tr_register/Tr_RegisterServletMP.do")

public class Tr_RegisterServletMP extends HttpServlet {
...
//		GlobalService.exploreParts(parts, request);
		...
		if (parts != null) { // 如果這是一個上傳資料的表單
			...
			if (!errorMsg.isEmpty()) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("tr-register.jsp");
...
//						GlobalService.encryptString(password));
					...
					StudentBean stdent = new StudentBean(null, null, name, phone, email, birthday, password, id, sex, null, null);
